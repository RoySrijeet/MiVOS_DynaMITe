...
def default_argument_parser(epilog=None):
    ...
    parser.add_argument("--iou-threshold",nargs='+',type=float, default=0.85,help="IoU threshold")
    parser.add_argument("--max-interactions",nargs='+',type=int, default=10,help="max interactions")
    parser.add_argument("--max-rounds",type=int, default=1,help="max rounds per sequence")
